<template>
    <div style="margin-top: 50px">
        <el-form :model="value" ref="productAttrForm" label-width="120px" style="width: 720px; margin: 0 auto" size="small">
...
<script>
    ...
    import {fetchProductAttrList} from '@/api/pms/attrList'
    ...
    export default {
        ...
        methods: {
            ...
            getProductAttrCateList() {
                fetchAttrCategoryAll().then(response => {
            ...
            getProductAttrList(type, cid) {
                fetchProductAttrList(cid, type).then(response => {
                    let list = response.data;
                    if (type === 0) {
            ...
            handleRemoveProductAttrValue(idx, index) {
                ...
                this.selectProductAttr[idx].values.remove(index)
