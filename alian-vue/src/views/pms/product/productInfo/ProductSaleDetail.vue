<template>
    <div style="margin-top: 50px">
        <el-form :model="value" ref="productSaleForm" label-width="120px" style="width: 600px; margin: 0 auto" size="small">
...
<script>
    ...
    import {fetchMemberLevelList} from '@/api/ums/memberLevel'
    ...
    export default {
        ...
        created() {
            if (this.isEdit) {
                ...
                fetchMemberLevelList(0).then(result => {
